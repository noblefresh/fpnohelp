...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-light" data-widget="" href="{{ route('home') }}" role="button"><i class="fas fa-chevron-left"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('home') }}" class="nav-link text-light">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('userblog') }}" class="nav-link text-light">Info</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link text-light" data-toggle="dropdown" id="profile" href="#">

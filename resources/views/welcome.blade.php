...
<head>
  ...
  <!-- App Icons -->
  <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('images/icon.png') }}">
  <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('images/icon.png') }}">
  ...
  <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('images/icon.png') }}">
...
<div class="center index-start">
  <a href="{{ route('register') }}" class='waves-light btn-large' style="background-color: #3490dc">  Get Started
  </a>
  <a href="{{ route('login') }}" class='login-link'>Already a member? Sign In</a>  <a href="{{ route('register') }}" class='register-link'>Register</a>
